...
describe("Verify User can work on Filter available Collections/Projects :", async () => {
  ...
  it("Click on Filter available Collections/Projects icon", async () => {
    ...
    try {
      ...
      console.log(
        "***filter avl collection is click bu custom chip is not showing in package tray "
      );
    }
  ...
  it("Verify behavior of Active cards section", async () => {
    ...
    await (await Collections.$Deactivted1stColl).waitForClickable();
    await (await Collections.$Deactivted1stColl).click();
    await (await Collections.$Activated3rdAvlColl).waitForClickable();
    await (await Collections.$Activated3rdAvlColl).click();
